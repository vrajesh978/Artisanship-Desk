...
<body>
	...
	<div class="form-w3agile">
		...
		<form:form name="resetForm" action="update.html" method="post"
			...
			<div class="key">
				<i class="fa fa-lock" aria-hidden="true"></i>
				<form:input path="" type="password" placeholder="reset Password"
					name="rPassword" onfocus="this.value = '';" required="true"
					id="rpassword" />
				<div class="clearfix"></div>
			</div>
