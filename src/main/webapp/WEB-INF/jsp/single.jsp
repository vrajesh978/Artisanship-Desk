...
<!-- cart -->
<script defer src="<c:url value = "/assets/js/jquery.flexslider.js"/>"></script>
<link rel="stylesheet"
	href="<c:url value = "/assets/css/flexslider.css"/>" type="text/css"
	media="screen" />
<script src="<c:url value = "/assets/js/imagezoom.js"/>"></script>
<script>
...
<!--//End-rate-->
<link href="<c:url value = "/assets/css/owl.carousel.css"/>"
	rel="stylesheet">
...
<body>
	...
	<div class="banner1">
		<div class="container">
			<h3>
				<a href="index.html">Home</a> / <span>Single</span>
			</h3>
		</div>
	</div>
	<!--banner-->
				...
				<div class="single-grids">
						...
						<div clas="single-top">
							<div class="single-left">
								<div class="flexslider">
									<ul class="slides">
										<li data-thumb="<c:url value = "/assets/images/si.jpg"/>">
											<div class="thumb-image">
												<img src="<c:url value = "/assets/images/si.jpg"/>"
													data-imagezoom="true" class="img-responsive">
											</div>
										</li>
										<li data-thumb="<c:url value = "/assets/images/si1.jpg"/>">
											<div class="thumb-image">
												<img src="<c:url value = "/assets/images/si1.jpg"/>"
													data-imagezoom="true" class="img-responsive">
											</div>
										</li>
										<li data-thumb="<c:url value = "/assets/images/si2.jpg"/>">
											<div class="thumb-image">
												<img src="<c:url value = "/assets/images/si2.jpg"/>"
													data-imagezoom="true" class="img-responsive">
											</div>
										</li>
									</ul>
							...
							<div class="single-right simpleCart_shelfItem">
								...
								<div class="description">
									<p>
										<span>Quick Overview : </span> In cursus faucibus tortor eu
										vestibulum. Ut eget turpis ac justo porta varius. Donec vel
										felis ante, ac vehicula ipsum. Quisque sed diam metus. Quisque
										eget leo sit amet erat varius rutrum vitae dapibus lectus.
										Vivamus et sapien ante. Suspendisse potenti. Fusce in tellus
										est, ac consequat.
									</p>
								</div>
								...
								<div class="women">
									<span class="size">XL / XXL / S </span> <a href="#"
					...
					<div class="col-md-3 single-grid1">
						...
						<div class="recent-grids">
							<div class="recent-left">
								<a href="single.html"><img class="img-responsive "
									src="<c:url value = "/assets/images/r.jpg"/>" alt=""></a>
							</div>
						...
						<div class="recent-grids">
							<div class="recent-left">
								<a href="single.html"><img class="img-responsive "
									src="<c:url value = "/assets/images/r1.jpg"/>" alt=""></a>
							</div>
							<div class="recent-right">
								<h6 class="best2">
						...
						<div class="recent-grids">
							<div class="recent-left">
								<a href="single.html"><img class="img-responsive "
									src="<c:url value = "/assets/images/r2.jpg"/>" alt=""></a>
							</div>
							<div class="recent-right">
								<h6 class="best2">
									<a href="single.html">Lorem ipsum dolor </a>
						...
						<div class="recent-grids">
							<div class="recent-left">
								<a href="single.html"><img class="img-responsive "
									src="<c:url value = "/assets/images/r3.jpg"/>" alt=""></a>
							</div>
							<div class="recent-right">
								<h6 class="best2">
					...
					<div class="product-grids">
						<div class="col-md-4 product-grid">
							<div id="owl-demo" class="owl-carousel">
								...
								<div class="item">
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive "
												src="<c:url value = "/assets/images/r4.jpg"/>" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2">
												<a href="single.html">Lorem ipsum dolor </a>
									...
									<div class="recent-grids">
										<div class="recent-left">
											<a href="single.html"><img class="img-responsive "
												src="<c:url value = "/assets/images/r5.jpg"/>" alt=""></a>
										</div>
										<div class="recent-right">
											<h6 class="best2">
												<a href="single.html">Duis aute irure </a>
							...
							<img class="img-responsive "
								src="<c:url value = "/assets/images/woo2.jpg"/>" alt="">
						</div>
								...
								<div class="bs-example bs-example-tabs" role="tabpanel"
									...
									<ul id="myTab" class="nav nav-tabs left-tab" role="tablist">
										...
										<li role="presentation"><a href="#reviews" role="tab"
											id="reviews-tab" data-toggle="tab" aria-controls="reviews">Reviews
												(1)</a></li>
									...
									<div id="myTabContent" class="tab-content">
										<div role="tabpanel" class="tab-pane fade in active" id="home"
											...
											<div class="descr">
												...
												<p class="quote">Ut wisi enim ad minim veniam, quis
												...
												<div class="video">
													<iframe src="https://player.vimeo.com/video/22158502"
												...
												<ul>
													...
													<li>Material : Outer: 40% Linen &amp; 40% Polyamide;
														Body Lining: 100% Cotton; Lining: 100% Acetate</li>
												</ul>
												<p class="quote">Ut wisi enim ad minim veniam, quis
													nostrud exerci tation ullamcorper suscipit lobortis nisl ut
													aliquip ex ea commodo consequat. Duis autem vel eum iriure
											...
											<div class="descr">
												<div class="reviews-top">
													<div class="reviews-left">
														<img src="<c:url value = "/assets/images/men3.jpg"/>"
										...
										<div role="tabpanel" class="tab-pane fade" id="custom"
											aria-labelledby="custom-tab"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="grid-arr">
							<div class="grid-arrival">
								<figure>
									<a href="single.html">
										<div class="grid-img">
											<img src="<c:url value = "/assets/images/p28.jpg"/>"
												class="img-responsive" alt="">
										</div>
										<div class="grid-img">
											<img src="<c:url value = "/assets/images/p27.jpg"/>"
												class="img-responsive" alt="">
										</div>
									</a>
								</figure>
